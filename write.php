...
<body id="target">
  <div class="container">
    ...
    <header class="jumbotron text-center">
      <img src="https://s3.ap-northeast-2.amazonaws.com/opentutorials-user-file/course/94.png" alt="장 상 협" class="img-circle" id="logo">
        <h1><a href="http://localhost/index.php">장 상 협</a></h1>
    </header>
    <div class="row">
